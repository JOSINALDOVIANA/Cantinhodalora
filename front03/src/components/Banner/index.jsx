...
function Banner() {
  ...
  return (<>
    ...
    >
      ...
      <Box maxWidth="lg" sx={{ position: "relative", py: { xs: 9, sm: 9 }, backgroundColor: theme.palette.mode === 'light' ? theme.palette.background.paper : theme.palette.primary.main, paddingLeft: 5 }}>
        <Typography
          variant="overline"
